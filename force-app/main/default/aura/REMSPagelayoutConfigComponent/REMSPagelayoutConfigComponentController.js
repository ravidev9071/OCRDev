({
    getLayoutName : function(component, event, helper) {
        ...
        if (params) {
            ...
            component.set("v.programName",params.programName);
            component.set("v.calledByFaxTransfo",params.calledByFaxTransfo);
			component.set("v.ProgramRecordType",params.ProgramRecordType);
		    helper.getLayoutSections(component,PGName);
            helper.getlookupfields(component, event, helper);
        }
    },
                ...
                if (state === "SUCCESS") {
                    ...
                    if (dupAcc['dupFound'] == false ){
                        ...
                        toastEvent.setParams({
                            ...
                            "type": "success" //7433 - 41 - Account Dup Check
                        });
                        toastEvent.fire();
                        ...
                        component.set('v.columns', [
                            ...
                            { label: 'REMS Program', fieldName: 'RemsProgramName', type: 'text' },
                            { label: 'First Name', fieldName: 'FirstName', type: 'text' },
                            { label: 'Last Name', fieldName: 'LastName', type: 'text' },
                            { label: 'Phone', fieldName: 'Phone', type: 'phone' },
                            { label: 'DOB', fieldName: 'US_WSREMS__DOB__c', type: 'date-local' },
                            //{ label: 'DEA', fieldName: 'US_WSREMS__DEA__c', type: 'text' }, //7433 - 41 - Account Dup Check
                            { label: 'NPI', fieldName: 'US_WSREMS__NPI__c', type: 'text' }, //7433 - 41 - Account Dup Check
    ...
    handleFieldChange : function(component, event, helper){
        ...
        if (newValue && lookupfields.includes(fieldName)){
            helper.getPrepopulationFields(component, event, helper , newValue, fieldName);
        }
    },
