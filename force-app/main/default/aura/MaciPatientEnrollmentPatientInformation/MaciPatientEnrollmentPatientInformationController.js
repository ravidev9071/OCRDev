({  
	...
	handleNext: function(component,event,helper){
        ...
        var today = new Date();
        var birthDate = new Date(component.get("v.newCase.US_WSREMS__DOB__c"));
        var errorMsg='';
        
        if (component.get("v.newCase.US_WSREMS__First_Name__c") == undefined || component.get("v.newCase.US_WSREMS__First_Name__c") == ''){
            errorMsg += ' First Name,'
        }
        
        if (component.get("v.newCase.US_WSREMS__Last_Name__c") == undefined || component.get("v.newCase.US_WSREMS__Last_Name__c") == ''){
            errorMsg += ' Last Name,'
        }
        
        if (component.get("v.newCase.US_WSREMS__Address_Line_1__c") == undefined || component.get("v.newCase.US_WSREMS__Address_Line_1__c") == ''){
            errorMsg += ' Address Line 1,'
        }
        
        if (component.get("v.newCase.US_WSREMS__City__c") == undefined || component.get("v.newCase.US_WSREMS__City__c") == ''){
            errorMsg += ' City,'
        }
        
       if (component.get("v.newCase.US_WSREMS__State__c") == undefined || component.get("v.newCase.US_WSREMS__State__c") == ''){
            errorMsg += ' State,'
        }
        
        if (component.get("v.newCase.US_WSREMS__REMS_Zip_Code__c") == undefined || component.get("v.newCase.US_WSREMS__REMS_Zip_Code__c") == ''){
            errorMsg += ' ZIP Code,'
        }
        
        if (component.get("v.newCase.US_WSREMS__DOB__c") == undefined || component.get("v.newCase.US_WSREMS__DOB__c") == ''){
            errorMsg += ' Date of Birth,'
        }
        
        if (component.get("v.newCase.US_WSREMS__Email__c") == undefined || component.get("v.newCase.US_WSREMS__Email__c") == ''){
            errorMsg += ' Email,'
        }
        ...
        }else if(component.get("v.newCase.SYN_Alternate_Phone__c") != undefined && component.get("v.newCase.SYN_Alternate_Phone__c") != '' && (!component.get("v.newCase.SYN_Alternate_Phone__c").replace(/[^0-9]+/g, "").match(numberpattern) || component.get("v.newCase.SYN_Alternate_Phone__c").match(alphaPattern))){
    ...
    handleRefresh: function(component, event, helper) {
       ...
       helper.handleOCRefresh(component,event);  
    },
    ...
    handlePrevious : function(component,event,helper){
        helper.fireEvent(component,event,'ShowInstructionScreen');
    },
    handlePrescriberPrevious : function(component,event,helper){
        helper.firePrescriberEvent(component,event,'ShowPatientAgmntInstructionsScreen');
    },
