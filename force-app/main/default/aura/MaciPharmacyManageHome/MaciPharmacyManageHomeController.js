({
    ...
    // RT 2349 changes
    navigateToHistory: function(component, event, helper) {
        var pharmAccount = component.get("v.pharmacy");
        var nav = component.find("navigation");
        var pageReference = {
        type: "comm__namedPage",
        attributes: {
            pageName: 'rda-history'
        },
          state: {
            accountId: pharmAccount.Id // Pass AccountId as a URL parameter
        }
        };
