           ...
           var state = result.getState();
            if (component.isValid() && state === "SUCCESS"){
                ...
                for (var i=0; i < listLength; i++) {
                    ...
                    if(resultData[i].US_WSREMS__Pharmacy_User__c == component.get("v.pharmacist.Id") && resultData[i].US_WSREMS__UserType__c != 'Authorized Representative' && resultData[i].Default__c == true){
