({  
    doInit : function(component,event,helper){ 
        ...
        var recrdId = url.searchParams.get("id");    
        helper.getCurrentAuthRepInfo(component, event);
	...
	handleNext: function(component, event, helper) {
        ...
        var username = component.get("v.pAccount.Email_address__c");
        var usernameOC = component.get("v.pAccount.US_WSREMS__Email__c");
       
        var lowerCaseLetters = /[a-z]/g;
        var numbers = /[0-9]/g;
	   if((usernameOC == undefined || usernameOC == '') && (username == undefined || username == '')){
    ...
    resendConfirmationMail : function(component, event, helper) {
       var junkMailVerification = $("#flexCheckDefault").is(":checked"); //$("#flexCheckDefault").val();
        if(junkMailVerification == true){
            ...
            helper.showToast(component,event,'Please select junk checkbox','warning'); 
        }
	},
