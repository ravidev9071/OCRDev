    ...
    handleForgotPassword: function (component, event, helpler) {
        ...
        action.setCallback(this, function(a) {
            ...
            if(userNameMap.length == 1){
                ...
                component.find('maciCustomNotification').showToast ("warning", "Sorry, We do not have user with provided email address, please contact the Macitentan REMS at 1-888-572-2934.");
            }
       });
