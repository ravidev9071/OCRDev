...
const fields = [Monitor_Participant_FIELD, CaseRecType_FIELD];
...
export default class DisplayAlertCmp extends LightningElement {
    ...
    get caseRecTypeName(){
       if (getFieldValue(this.rdaCaseData.data, Monitor_Participant_FIELD) && 
           getFieldValue(this.rdaCaseData.data, CaseRecType_FIELD) == 'REMS Dispense Authorization') {
           return true;
       }
       return false;
