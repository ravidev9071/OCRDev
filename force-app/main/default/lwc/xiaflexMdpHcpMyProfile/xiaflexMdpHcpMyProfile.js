...
const accMap = {
    ...
    US_WSREMS__Hold_Account__c: undefined
}
...
*/
    ...
    handleInputChange(event) {
        ...
        if(this.eventName == 'sig'){
            this.modifiedonhold = event.target.checked;
    ...
    saveModal() {
       // this.disableSave = true;
        ...
        if( this.modifiedonhold != this.onholdValue){
            this.accountMaptoUpdate.US_WSREMS__Hold_Account__c =  this.modifiedonhold;
        }
    ...
    getAccDetails() {
        getLoggedInUserDetails()
            .then(result => {
                ...
                this.onholdValue = result[0].Account.US_WSREMS__Hold_Account__c;
